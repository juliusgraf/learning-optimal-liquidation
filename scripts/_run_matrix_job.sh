...
case "$block" in
  ...
  MSFT|JPM|PG|GOOGL|CAT)
    ...
    ;;
  mechanism_fixed_anchor|mechanism_economic_dense|mechanism_economic_sparse|mechanism_h_feature_off|mechanism_clob_shaping|mechanism_auction_shaping|no_auction)
