...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    -h|--help)
      echo "usage: $0 [--seeds \"42 7 99 123 2024\"] [--jobs N] [--threads-per-job N] [--smoke] [--symbol TICKER] [--dry-run]"
      exit 0
      ;;
...
QUEUE_ARGS=(--root "${LMM_RESULTS_ROOT:-results/revision_v17}" --seeds $SEEDS
