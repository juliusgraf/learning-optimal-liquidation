...
``H_on__shaping_on__auction_on`` arm.  Keeping that mapping here avoids a second
set of numerically identical training runs under the old
``ablation_h_on_shaping_on`` directory name.
"""
